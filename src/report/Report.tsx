...
export function Report({ events }: { events: EditEvent[] }) {
  return (
    <div data-testid="report">
      <section className="card"><h2>Summary</h2><p className="sub">Totals, typing speed, and first/last edit</p></section>
      ...
      <section className="card"><h2>Sessions &amp; Breaks</h2><p className="sub">When you worked and when you paused</p></section>
